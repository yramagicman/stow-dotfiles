...
hi      Normal           ctermfg=253     ctermbg=none    guifg=#dadada  guibg=#1c1c1c
hi      Type             gui=bold        term=bold      cterm=none     ctermfg=34     guifg=#00af00
hi      VertSplit        guifg=#808080   guibg=#080808  gui=bold       ctermfg=63    ctermbg=none    cterm=bold
...
hi      Search           ctermbg=27      ctermfg=255    guibg=#000000  guifg=#ffffff
hi      CursorLine       ctermbg=25      ctermfg=123  cterm=none     guibg=#262626
hi      FoldColumn       ctermbg=none    ctermfg=247    guifg=#1c1c1c  guibg=#1c1c1c
hi      Folded           ctermbg=none    ctermfg=247    guifg=#9e9e9e  guibg=#1c1c1c
...
hi      ColorColumn      term=none       cterm=none     ctermbg=25    ctermfg=123  guibg=#080808
...
hi      StatusLine       ctermfg=26     ctermbg=16    guifg=#080808  guibg=#949494
hi      StatusLineNC     ctermfg=26     ctermbg=233    guifg=#080808  guibg=#949494
if      has("spell")
